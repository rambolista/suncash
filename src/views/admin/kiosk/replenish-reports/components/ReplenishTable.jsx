...
// Kiosk Terminal / Island / Location are filtered via a dropdown of the values actually present, not free text.
const DROPDOWN_COLUMNS = { 1: 'kiosk_terminal', 2: 'island', 3: 'location' }
