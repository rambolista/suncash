...
const GeoPromoForm = ({ promo, readOnly, countries, onBack, onSaved }) => {
  ...
  const title = readOnly ? 'View Sign Up Promotion Zone' : promo ? 'Edit Sign Up Promotion Zone' : 'Add Sign Up Promotion Zone'
    ...
    <>
      ...
      <Card>
        ...
        <Card.Footer className="d-flex justify-content-end gap-2">
          <Button variant="light" onClick={onBack}>{readOnly ? 'Close' : 'Cancel'}</Button>
          {!readOnly && (
