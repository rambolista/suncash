...
const columns = [
  ...
  textCol('ip_address'),
  textCol('risk_score'),
  textCol('risk_reasons'),
  textCol('message'),
  textCol('remarks'),
  textCol('source'),
]

const headers = ['Timestamp', 'Customer Name', 'Mobile', 'Model', 'UUID', 'Geolocation', 'Country', 'IP Address', 'Risk Score', 'Risk Reason', 'Message', 'Remarks', 'Source']
...
export default CustomerFailedLogsTable
