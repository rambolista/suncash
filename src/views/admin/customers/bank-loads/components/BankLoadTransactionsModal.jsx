...
const BankLoadTransactionsModal = ({ show, onHide, bankLoadId, customerName }) => {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    ApiService.getCustomerBankLoadTransactions(bankLoadId)
...
export default BankLoadTransactionsModal
