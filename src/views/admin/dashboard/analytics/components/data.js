...
export const campaignsData = [
  {
    ...
    icon: 'rocket',
    iconProps: {
      className: 'fs-lg me-1 text-primary',
    },
    visitors: 502,
    newUsers: 260,
    sessions: 6845,
  ...
  },
  {
    ...
    icon: 'brand-facebook',
    iconProps: {
      className: 'fs-lg me-1 text-info',
    },
    visitors: 478,
    newUsers: 245,
    sessions: 6120,
  ...
  },
  {
    ...
    icon: 'speakerphone',
    iconProps: {
      className: 'fs-lg me-1 text-success',
    },
    visitors: 445,
    newUsers: 230,
    sessions: 5710,
  ...
  },
  {
    ...
    icon: 'mail-fast',
    iconProps: {
      className: 'fs-lg me-1 text-warning',
    },
    visitors: 392,
    newUsers: 190,
    sessions: 5210,
  ...
  },
  {
    ...
    icon: 'broadcast',
    iconProps: {
      className: 'fs-lg me-1 text-muted',
    },
    visitors: 338,
    newUsers: 160,
    sessions: 4670,
...
export const getOrdersChartOptions = () => ({
  series: [
    {
      type: 'column',
      data: [
...
export const getPostsChartOptions = () => ({
  chart: {
    type: 'area',
    height: 60,
    sparkline: {
