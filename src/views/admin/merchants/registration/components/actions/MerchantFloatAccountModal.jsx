...
const MerchantFloatAccountModal = ({ show, onHide, merchant }) => {
  ...
  return (
    <Modal show={show} onHide={onHide} centered>
      <Modal.Header closeButton>
        <Modal.Title>Store Float Account — {merchant?.dba_name || merchant?.legal_name}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {loading ? (
...
export default MerchantFloatAccountModal
