...
const MerchantTerminalModal = ({ show, onHide, merchant }) => {
  ...
  return (
    <Modal show={show} onHide={onHide} centered size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Terminals — {merchant?.dba_name || merchant?.legal_name}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {loading ? (
            ...
            <div className="table-responsive">
              <Table size="sm" className="align-middle mb-2">
                <thead className="thead-sm text-uppercase fs-xxs">
                  <tr><th>Device ID</th><th>Type</th><th>Brand/Model</th><th>Status</th><th /></tr>
                </thead>
                <tbody>
...
export default MerchantTerminalModal
