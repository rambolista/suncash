...
const AgentCommissionPanel = ({ merchant, editable }) => {
        ...
        <Row className="g-3">
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Select disabled={!editable} value={settings.commi_type_id} onChange={(e) => setSettings((prev) => ({ ...prev, commi_type_id: Number(e.target.value) }))}>
          ...
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control type="number" min="0" step="0.01" disabled={!editable} value={settings.commi_fixed} onChange={(e) => setSettings((prev) => ({ ...prev, commi_fixed: e.target.value }))} isInvalid={!!errors.commi_fixed} />
          ...
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control type="number" min="0" step="0.01" disabled={!editable} value={settings.commi_percentage} onChange={(e) => setSettings((prev) => ({ ...prev, commi_percentage: e.target.value }))} isInvalid={!!errors.commi_percentage} />
          ...
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control type="number" min="0" step="0.01" disabled={!editable} value={settings.wu_commi_percentage} onChange={(e) => setSettings((prev) => ({ ...prev, wu_commi_percentage: e.target.value }))} isInvalid={!!errors.wu_commi_percentage} />
