        ...
        <Row>
          <Col lg={8} className="mx-auto text-center">
            ...
            <div className="d-flex gap-2 flex-wrap justify-content-center">
              <Link to={META_DATA.buyUrl} className="btn btn-secondary py-2 fw-semibold d-flex align-items-center">
                <Icon icon="basket" className="fs-xl me-2" /> Buy Now!
              </Link>
              <a className="btn btn-light py-2 fw-semibold d-flex align-items-center" href="#contact">
                <Icon icon="confetti" className="fs-xl me-2" /> Contact Us
              </a>
            </div>
          </Col>
        </Row>
