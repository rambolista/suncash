...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/transactions/resend-voucher',
        Component: lazy(() => import('@/views/admin/transactions/resend-voucher')),
      },
      {
      ...
      {
        path: '/tools/payment-management',
        Component: lazy(() => import('@/views/admin/tools/payment-management')),
      },
      {
